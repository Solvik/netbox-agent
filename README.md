...
* PowerEdge M1000e (your `DeviceType` should have slots named `Slot 01` and so on, [see example](https://github.com/Solvik/netbox_agent/blob/docs/docs/img/M1000e.png?raw=true))
* PowerEdge M640
* PowerEdge M630
* PowerEdge M620
* PowerEdge M610
